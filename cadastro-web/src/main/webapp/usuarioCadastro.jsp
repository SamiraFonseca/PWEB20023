...
>
  <head>
    ...
    <title>Cadastro Web - Cadastrar Usuário</title>
          ...
          <div class="card">
            <div class="card-body">
              <!-- Logo -->
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">CADASTRO</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Cadastro de Usuário</h4>
              <p class="mb-4">Realize o seu cadastro aqui!</p>

              <form id="formAuthentication" class="mb-3" action="cadastrarUsuario" method="POST">
                <div class="mb-3">
              ...
              <p class="text-center">
                <span>Deseja visualizar os usuários já cadastrados?</span>
